...
p2.ships.append(Ship(2, [Coordinates('a', 5), Coordinates('a', 6), Coordinates('a', 7)]))
...
def status_c(coordinates):
    ...
    return render_template('status.html', data={"active_player": g.turn, "result": result, "e":{'test':'case'}})
